...
from model.MIFE import MVF, MIFE
from model.MCFF import MCFF
...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.mife = MIFE(depth=args.mife, embed_dim=args.channel, length=args.frames)

        ## Multi-view cross-level feature fuser(MCFF)
        self.mcff = MCFF(args.mcff, args.channel, args.d_hid, length=args.frames)
