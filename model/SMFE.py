...
class SMFE(nn.Module):
    def __init__(self, args):
        ...
        self.Transformer_encoder_1 = Transformer(int(args.ssfe[0]), args.frames, args.frames * 2,
                                                 length=2 * args.n_joints, h=9)
        self.Transformer_encoder_2 = Transformer(int(args.ssfe[1]), args.frames, args.frames * 2,
                                                 length=2 * args.n_joints, h=9)
        self.Transformer_encoder_3 = Transformer(int(args.ssfe[2]), args.frames, args.frames * 2,
                                                 length=2 * args.n_joints, h=9)
